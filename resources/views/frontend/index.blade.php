                                                ...
                                                <div class="col-md-3 col-lg-3 col-sm-12">
                                                 <div class="card border-0 box_shadow">
                                                     ...
                                                     <div class="card-footer  bg-ffffff pt-4 pb-4">
                                                       ...
                                                       <p class="card-text m-0 robotoRegular cl-6 cl-6b6b6b f-21 pt-1">By graphics colors</p>
                                                     </div>
                                   ...
                                   <section class="main_padding pt-70  w-100">
                                    <div class="row m-0 justify-content-between">
                                        ...
                                        <div class="col-md-2 p-0">
                                          <div>  <h4 class="m-0 cl-000000 robotoMedium f-26">Join Us On</h4>
                                        </div>
                                        <div class="pt-4"> <input type="email" placeholder="Enter your email..." class="robotoRegular cl-6b6b6b    bg-transparent footer_input pt-2 pb-2 pl-3 w-100 rounded">
                                        </div>
