            ...
            <div class="col-md-3 ">
                <div class="bg-white pl-3 pr-3">
                    <div class="pt-4 pb-4" style="min-height: 702px; max-height: 702px;">
                        <div class="pr">
                          <img src="{{asset('assets/frontend/images/chat/smallprofile.png')}}" class="rounded-circle img-fluid main-profile" alt="" srcset="">
                          <div class="small-Circle bg-grey  user-staus-{{ $user->id }}"></div>
                        </div>
                        <div class="text-center f-22 cl-5757575">{{ ucwords($user->name) }}</div>
                        <div class="cl-a8a8a8 f-17 text-center">Hair Stylist</div>
                        ...
                        <div class="row m-0  pt-3 pb-3 border-bottom cl-a8a8a8">
                          ...
                          <div class="col-md-6 col-md-6 p-0 text-end d-flex justify-content-end">
                            <div class="f-17 text-end">United States</div>
                          </div>
                        </div>
                        <div class="row m-0  pt-3 pb-3 border-bottom cl-a8a8a8">
                          <div class="col-md-6 col-md-6 p-0 ">
                            <div class="f-17 text-end" >English</div>
                          </div>
                          <div class="col-md-6 col-md-6 p-0 text-end d-flex justify-content-end">
                        ...
                        <div class="row m-0  pt-3 pb-3 border-bottom cl-a8a8a8">
                          <div class="col-md-6 col-md-6 p-0 ">
                            <div class="f-17 text-end">French</div>
                          </div>
                          <div class="col-md-6 col-md-6 p-0 text-end d-flex justify-content-end">
                            <div class="f-17 text-end">Secondary</div>
                          </div>
                        </div>
                        <div class="row m-0  pt-3 pb-3  cl-a8a8a8">
                          <div class="col-md-6 col-md-6 p-0">
                            <div class="f-17 text-end" >Portuguese</div>
                          </div>
                          <div class="col-md-6 col-md-6 p-0 text-end d-flex justify-content-end">
                            <div class="f-17 text-end">Secondary</div>
                          </div>
                			        ...
                			        @foreach(App\User::where('id', '!=',Auth::user()->id)->get() as $u)
                			            <a href="{{ route('chat.index',$u->id) }}" class="h-85 border  list-group-item-action   border-left-0 border-right-0 @if($user->id==$u->id) bg-3ac754 text-white @else bg-white @endif">
                			                   <div class="row m-0  pt-3">
                                                <div class="col-md-3">
                                                    <div class="parent"><img src="{{asset('assets/frontend/images/chat/smallprofile.png')}}" class="rounded-circle img-fluid smallProfile" alt=""
                                                    srcset="">
	            ...
	            <div class="card" style="min-height: 702px; max-height: 702px;">
        			<div class="card-header">
        			   <div class="row m-0 align-items-center">
        			       ...
        			       <div class="d-flex">
        			           <div>  <div class="parent"><img src="{{asset('assets/frontend/images/chat/smallprofile.png')}}" class="rounded-circle img-fluid smallProfile" alt=""
                                srcset="">
