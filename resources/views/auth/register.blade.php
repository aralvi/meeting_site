                            ...
                            <fieldset>
                                ...
                                <div class="pl-5 pr-5">
                                    ...
                                    <div class="input-group mb-3 border-input pt-3">
                                        <span><img src="{{ asset('assets/frontend/images/men-8 (1).png') }}" class="w-24" alt="" /></span>
                                    ...
                                    <div class="input-group mb-3 border-input pt-3">
                                        <span><img src="{{ asset('assets/frontend/images/sms -8.png') }}" class="w-24" alt="" /></span>
                                        <span class="w-75"><input type="email" class="form-control border-0" placeholder="Enter your email" aria-label="" aria-describedby="basic-addon1" /></span>
                                    </div>
                                    <div class="input-group mb-3 border-input pt-3 ">
                                        <span><img src="{{ asset('assets/frontend/images/key-8.png') }}" class="w-24" alt="" /></span>
                                        <span class="w-75"><input type="password" class="form-control border-0" placeholder="Enter your password" aria-label="" aria-describedby="basic-addon1" /></span>
                                    </div>
                                    <div class="input-group mb-3 border-input pt-3 ">
                                        <span><img src="{{ asset('assets/frontend/images/key-8.png') }}" class="w-24" alt="" /></span>
                                        <span class="w-75"><input type="password" class="form-control border-0" placeholder="Confirm your password" aria-label="" aria-describedby="basic-addon1" /></span>
                                    </div>
